...
class VegetableResource extends Resource
{
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('name')
                    ->required()
                    ->maxLength(255),
                Select::make('default_measurement_unit_id')
                    ->relationship('default_measurement_unit', 'name')
                // Forms\Components\TextInput::make('default_measurement_unit_id')
                //     ->required()
                //     ->numeric(),
            ]);
    }
    ...
    {
        return [
            'index' => Pages\ManageVegetables::route('/'),
        ];
    }
